...
namespace com.nkm.framework.resource.data {
  ...
  public sealed partial class MANOR_LEVEL : pb::GeneratedMessageLite<MANOR_LEVEL, MANOR_LEVEL.Builder> {
    ...
    public sealed partial class Builder : pb::GeneratedBuilderLite<MANOR_LEVEL, Builder> {
      ...
      public override MANOR_LEVEL DefaultInstanceForType {
        get { return global::com.nkm.framework.resource.data.MANOR_LEVEL.DefaultInstance; }
      }
      ...
      public override Builder MergeFrom(MANOR_LEVEL other) {
        if (other == global::com.nkm.framework.resource.data.MANOR_LEVEL.DefaultInstance) return this;
        PrepareBuilder();
        if (other.HasId) {
          Id = other.Id;
        }
    ...
    static MANOR_LEVEL() {
      object.ReferenceEquals(global::com.nkm.framework.resource.data.ManorLevelBytes.Descriptor, null);
    }
  }
  ...
  public sealed partial class MANOR_LEVEL_ARRAY : pb::GeneratedMessageLite<MANOR_LEVEL_ARRAY, MANOR_LEVEL_ARRAY.Builder> {
    ...
    private pbc::PopsicleList<global::com.nkm.framework.resource.data.MANOR_LEVEL> items_ = new pbc::PopsicleList<global::com.nkm.framework.resource.data.MANOR_LEVEL>();
    public scg::IList<global::com.nkm.framework.resource.data.MANOR_LEVEL> ItemsList {
      get { return items_; }
    }
    public int ItemsCount {
      get { return items_.Count; }
    }
    public global::com.nkm.framework.resource.data.MANOR_LEVEL GetItems(int index) {
      return items_[index];
    }
    ...
    public override bool IsInitialized {
      get {
        foreach (global::com.nkm.framework.resource.data.MANOR_LEVEL element in ItemsList) {
    ...
    public override int GetHashCode() {
      int hash = GetType().GetHashCode();
      foreach(global::com.nkm.framework.resource.data.MANOR_LEVEL i in items_)
        hash ^= i.GetHashCode();
      return hash;
    }
    ...
    public sealed partial class Builder : pb::GeneratedBuilderLite<MANOR_LEVEL_ARRAY, Builder> {
      ...
      public override MANOR_LEVEL_ARRAY DefaultInstanceForType {
        get { return global::com.nkm.framework.resource.data.MANOR_LEVEL_ARRAY.DefaultInstance; }
      }
      ...
      public override Builder MergeFrom(MANOR_LEVEL_ARRAY other) {
        if (other == global::com.nkm.framework.resource.data.MANOR_LEVEL_ARRAY.DefaultInstance) return this;
        PrepareBuilder();
      ...
      public override Builder MergeFrom(pb::ICodedInputStream input, pb::ExtensionRegistry extensionRegistry) {
        ...
        while (input.ReadTag(out tag, out field_name)) {
          ...
          switch (tag) {
            ...
            case 10: {
              input.ReadMessageArray(tag, field_name, result.items_, global::com.nkm.framework.resource.data.MANOR_LEVEL.DefaultInstance, extensionRegistry);
              break;
            }
          }
        }
      ...
      public pbc::IPopsicleList<global::com.nkm.framework.resource.data.MANOR_LEVEL> ItemsList {
      ...
      public Builder SetItems(int index, global::com.nkm.framework.resource.data.MANOR_LEVEL value) {
        pb::ThrowHelper.ThrowIfNull(value, "value");
        PrepareBuilder();
        result.items_[index] = value;
        return this;
      }
      public Builder SetItems(int index, global::com.nkm.framework.resource.data.MANOR_LEVEL.Builder builderForValue) {
        pb::ThrowHelper.ThrowIfNull(builderForValue, "builderForValue");
        PrepareBuilder();
        result.items_[index] = builderForValue.Build();
        return this;
      }
      public Builder AddItems(global::com.nkm.framework.resource.data.MANOR_LEVEL value) {
        pb::ThrowHelper.ThrowIfNull(value, "value");
        PrepareBuilder();
        result.items_.Add(value);
        return this;
      }
      public Builder AddItems(global::com.nkm.framework.resource.data.MANOR_LEVEL.Builder builderForValue) {
        pb::ThrowHelper.ThrowIfNull(builderForValue, "builderForValue");
        PrepareBuilder();
        result.items_.Add(builderForValue.Build());
        return this;
      }
      public Builder AddRangeItems(scg::IEnumerable<global::com.nkm.framework.resource.data.MANOR_LEVEL> values) {
        PrepareBuilder();
