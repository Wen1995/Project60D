...
public class TimerManager 
{
	...
	ITimerDao timerDao = (ITimerDao) Constant.context.getBean("timerDao");
	...
	public ScheduledFuture<?> sumbit(String key, final Long uid, final Integer cmd, final byte[] buffer, int delaySec)
	{
	...
	public ScheduledFuture<?> scheduleAtFixedRate(final Integer cmd, final byte[] buffer, int delay, int period)
    {
