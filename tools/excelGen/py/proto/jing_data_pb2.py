...
DESCRIPTOR.message_types_by_name['JING'] = _JING
DESCRIPTOR.message_types_by_name['JING_ARRAY'] = _JING_ARRAY

JING = _reflection.GeneratedProtocolMessageType('JING', (_message.Message,), dict(
  DESCRIPTOR = _JING,
  __module__ = 'proto.jing_data_pb2'
