...
_BUILDING = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='bldg_visible', full_name='com.game.framework.resource.data.BUILDING.bldg_visible', index=4,
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='bldg_lv_lim', full_name='com.game.framework.resource.data.BUILDING.bldg_lv_lim', index=16,
