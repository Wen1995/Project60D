...
namespace com.game.framework.resource.data {
  ...
  public sealed partial class PLAYER_ATTR : pb::GeneratedMessageLite<PLAYER_ATTR, PLAYER_ATTR.Builder> {
    ...
    public sealed partial class Builder : pb::GeneratedBuilderLite<PLAYER_ATTR, Builder> {
      ...
      public override PLAYER_ATTR DefaultInstanceForType {
        get { return global::com.game.framework.resource.data.PLAYER_ATTR.DefaultInstance; }
      }
      ...
      public override Builder MergeFrom(PLAYER_ATTR other) {
        if (other == global::com.game.framework.resource.data.PLAYER_ATTR.DefaultInstance) return this;
        PrepareBuilder();
        if (other.HasId) {
          Id = other.Id;
        }
    ...
    static PLAYER_ATTR() {
      object.ReferenceEquals(global::com.game.framework.resource.data.PlayerAttrBytes.Descriptor, null);
    }
  }
  ...
  public sealed partial class PLAYER_ATTR_ARRAY : pb::GeneratedMessageLite<PLAYER_ATTR_ARRAY, PLAYER_ATTR_ARRAY.Builder> {
    ...
    private pbc::PopsicleList<global::com.game.framework.resource.data.PLAYER_ATTR> items_ = new pbc::PopsicleList<global::com.game.framework.resource.data.PLAYER_ATTR>();
    public scg::IList<global::com.game.framework.resource.data.PLAYER_ATTR> ItemsList {
      get { return items_; }
    }
    public int ItemsCount {
      get { return items_.Count; }
    }
    public global::com.game.framework.resource.data.PLAYER_ATTR GetItems(int index) {
      return items_[index];
    }
    ...
    public override bool IsInitialized {
      get {
        foreach (global::com.game.framework.resource.data.PLAYER_ATTR element in ItemsList) {
    ...
    public override int GetHashCode() {
      int hash = GetType().GetHashCode();
      foreach(global::com.game.framework.resource.data.PLAYER_ATTR i in items_)
        hash ^= i.GetHashCode();
      return hash;
    }
    ...
    public sealed partial class Builder : pb::GeneratedBuilderLite<PLAYER_ATTR_ARRAY, Builder> {
      ...
      public override PLAYER_ATTR_ARRAY DefaultInstanceForType {
        get { return global::com.game.framework.resource.data.PLAYER_ATTR_ARRAY.DefaultInstance; }
      }
      ...
      public override Builder MergeFrom(PLAYER_ATTR_ARRAY other) {
        if (other == global::com.game.framework.resource.data.PLAYER_ATTR_ARRAY.DefaultInstance) return this;
        PrepareBuilder();
      ...
      public override Builder MergeFrom(pb::ICodedInputStream input, pb::ExtensionRegistry extensionRegistry) {
        ...
        while (input.ReadTag(out tag, out field_name)) {
          ...
          switch (tag) {
            ...
            case 10: {
              input.ReadMessageArray(tag, field_name, result.items_, global::com.game.framework.resource.data.PLAYER_ATTR.DefaultInstance, extensionRegistry);
              break;
            }
          }
        }
      ...
      public pbc::IPopsicleList<global::com.game.framework.resource.data.PLAYER_ATTR> ItemsList {
      ...
      public Builder SetItems(int index, global::com.game.framework.resource.data.PLAYER_ATTR value) {
        pb::ThrowHelper.ThrowIfNull(value, "value");
        PrepareBuilder();
        result.items_[index] = value;
        return this;
      }
      public Builder SetItems(int index, global::com.game.framework.resource.data.PLAYER_ATTR.Builder builderForValue) {
        pb::ThrowHelper.ThrowIfNull(builderForValue, "builderForValue");
        PrepareBuilder();
        result.items_[index] = builderForValue.Build();
        return this;
      }
      public Builder AddItems(global::com.game.framework.resource.data.PLAYER_ATTR value) {
        pb::ThrowHelper.ThrowIfNull(value, "value");
        PrepareBuilder();
        result.items_.Add(value);
        return this;
      }
      public Builder AddItems(global::com.game.framework.resource.data.PLAYER_ATTR.Builder builderForValue) {
        pb::ThrowHelper.ThrowIfNull(builderForValue, "builderForValue");
        PrepareBuilder();
        result.items_.Add(builderForValue.Build());
        return this;
      }
      public Builder AddRangeItems(scg::IEnumerable<global::com.game.framework.resource.data.PLAYER_ATTR> values) {
        PrepareBuilder();
