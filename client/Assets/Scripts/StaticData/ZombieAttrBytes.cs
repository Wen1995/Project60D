...
namespace com.nkm.framework.resource.data {
  ...
  public sealed partial class ZOMBIE_ATTR : pb::GeneratedMessageLite<ZOMBIE_ATTR, ZOMBIE_ATTR.Builder> {
    ...
    public sealed partial class Builder : pb::GeneratedBuilderLite<ZOMBIE_ATTR, Builder> {
      ...
      public override ZOMBIE_ATTR DefaultInstanceForType {
        get { return global::com.nkm.framework.resource.data.ZOMBIE_ATTR.DefaultInstance; }
      }
      ...
      public override Builder MergeFrom(ZOMBIE_ATTR other) {
        if (other == global::com.nkm.framework.resource.data.ZOMBIE_ATTR.DefaultInstance) return this;
        PrepareBuilder();
        if (other.HasId) {
          Id = other.Id;
        }
    ...
    static ZOMBIE_ATTR() {
      object.ReferenceEquals(global::com.nkm.framework.resource.data.ZombieAttrBytes.Descriptor, null);
    }
  }
  ...
  public sealed partial class ZOMBIE_ATTR_ARRAY : pb::GeneratedMessageLite<ZOMBIE_ATTR_ARRAY, ZOMBIE_ATTR_ARRAY.Builder> {
    ...
    private pbc::PopsicleList<global::com.nkm.framework.resource.data.ZOMBIE_ATTR> items_ = new pbc::PopsicleList<global::com.nkm.framework.resource.data.ZOMBIE_ATTR>();
    public scg::IList<global::com.nkm.framework.resource.data.ZOMBIE_ATTR> ItemsList {
      get { return items_; }
    }
    public int ItemsCount {
      get { return items_.Count; }
    }
    public global::com.nkm.framework.resource.data.ZOMBIE_ATTR GetItems(int index) {
      return items_[index];
    }
    ...
    public override bool IsInitialized {
      get {
        foreach (global::com.nkm.framework.resource.data.ZOMBIE_ATTR element in ItemsList) {
    ...
    public override int GetHashCode() {
      int hash = GetType().GetHashCode();
      foreach(global::com.nkm.framework.resource.data.ZOMBIE_ATTR i in items_)
        hash ^= i.GetHashCode();
      return hash;
    }
    ...
    public sealed partial class Builder : pb::GeneratedBuilderLite<ZOMBIE_ATTR_ARRAY, Builder> {
      ...
      public override ZOMBIE_ATTR_ARRAY DefaultInstanceForType {
        get { return global::com.nkm.framework.resource.data.ZOMBIE_ATTR_ARRAY.DefaultInstance; }
      }
      ...
      public override Builder MergeFrom(ZOMBIE_ATTR_ARRAY other) {
        if (other == global::com.nkm.framework.resource.data.ZOMBIE_ATTR_ARRAY.DefaultInstance) return this;
        PrepareBuilder();
      ...
      public override Builder MergeFrom(pb::ICodedInputStream input, pb::ExtensionRegistry extensionRegistry) {
        ...
        while (input.ReadTag(out tag, out field_name)) {
          ...
          switch (tag) {
            ...
            case 10: {
              input.ReadMessageArray(tag, field_name, result.items_, global::com.nkm.framework.resource.data.ZOMBIE_ATTR.DefaultInstance, extensionRegistry);
              break;
            }
          }
        }
      ...
      public pbc::IPopsicleList<global::com.nkm.framework.resource.data.ZOMBIE_ATTR> ItemsList {
      ...
      public Builder SetItems(int index, global::com.nkm.framework.resource.data.ZOMBIE_ATTR value) {
        pb::ThrowHelper.ThrowIfNull(value, "value");
        PrepareBuilder();
        result.items_[index] = value;
        return this;
      }
      public Builder SetItems(int index, global::com.nkm.framework.resource.data.ZOMBIE_ATTR.Builder builderForValue) {
        pb::ThrowHelper.ThrowIfNull(builderForValue, "builderForValue");
        PrepareBuilder();
        result.items_[index] = builderForValue.Build();
        return this;
      }
      public Builder AddItems(global::com.nkm.framework.resource.data.ZOMBIE_ATTR value) {
        pb::ThrowHelper.ThrowIfNull(value, "value");
        PrepareBuilder();
        result.items_.Add(value);
        return this;
      }
      public Builder AddItems(global::com.nkm.framework.resource.data.ZOMBIE_ATTR.Builder builderForValue) {
        pb::ThrowHelper.ThrowIfNull(builderForValue, "builderForValue");
        PrepareBuilder();
        result.items_.Add(builderForValue.Build());
        return this;
      }
      public Builder AddRangeItems(scg::IEnumerable<global::com.nkm.framework.resource.data.ZOMBIE_ATTR> values) {
        PrepareBuilder();
