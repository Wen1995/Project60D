...
_BUILDING = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='bldgcap_key', full_name='com.game.framework.resource.data.BUILDING.bldgcap_key', index=5,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='bldgspd_key', full_name='com.game.framework.resource.data.BUILDING.bldgspd_key', index=6,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='in_use', full_name='com.game.framework.resource.data.BUILDING.in_use', index=7,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='max_bldg_lvl', full_name='com.game.framework.resource.data.BUILDING.max_bldg_lvl', index=8,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='prefab_name', full_name='com.game.framework.resource.data.BUILDING.prefab_name', index=9,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='icon_name', full_name='com.game.framework.resource.data.BUILDING.icon_name', index=10,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='bldg_info', full_name='com.game.framework.resource.data.BUILDING.bldg_info', index=11,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='con_id', full_name='com.game.framework.resource.data.BUILDING.con_id', index=12,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='con_pro', full_name='com.game.framework.resource.data.BUILDING.con_pro', index=13,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='pro_id', full_name='com.game.framework.resource.data.BUILDING.pro_id', index=14,
