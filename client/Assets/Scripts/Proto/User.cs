...
namespace com.nkm.framework.protocol {
  ...
  public sealed partial class TCSGetWorldEvent : pb::GeneratedMessageLite<TCSGetWorldEvent, TCSGetWorldEvent.Builder> {
    ...
    private static readonly string[] _tCSGetWorldEventFieldNames = new string[] { "startTime" };
    private static readonly uint[] _tCSGetWorldEventFieldTags = new uint[] { 8 };
    #if UNITY_EDITOR
     [pb.FieldNumber] 
     #endif//
    ...
    public override void WriteTo(pb::ICodedOutputStream output) {
      ...
      if (hasStartTime) {
        output.WriteInt64(1, field_names[0], StartTime);
      }
    }
    ...
    public sealed partial class Builder : pb::GeneratedBuilderLite<TCSGetWorldEvent, Builder> {
      ...
      public override TCSGetWorldEvent DefaultInstanceForType {
        get { return global::com.nkm.framework.protocol.TCSGetWorldEvent.DefaultInstance; }
      }
      ...
      public override Builder MergeFrom(TCSGetWorldEvent other) {
        if (other == global::com.nkm.framework.protocol.TCSGetWorldEvent.DefaultInstance) return this;
        PrepareBuilder();
  ...
  public sealed partial class TSCGetWorldEvent : pb::GeneratedMessageLite<TSCGetWorldEvent, TSCGetWorldEvent.Builder> {
    ...
    private static readonly string[] _tSCGetWorldEventFieldNames = new string[] { "worldEvents" };
    private static readonly uint[] _tSCGetWorldEventFieldTags = new uint[] { 10 };
    #if UNITY_EDITOR
     [pb.FieldNumber] 
     #endif//
    ...
    [pb.FieldNumber]
    #endif//
    public const int WorldEventsFieldNumber = 1;
    private pbc::PopsicleList<global::com.nkm.framework.protocol.WorldEvent> worldEvents_ = new pbc::PopsicleList<global::com.nkm.framework.protocol.WorldEvent>();
    public scg::IList<global::com.nkm.framework.protocol.WorldEvent> WorldEventsList {
      get { return worldEvents_; }
    }
    public int WorldEventsCount {
      get { return worldEvents_.Count; }
    }
    public global::com.nkm.framework.protocol.WorldEvent GetWorldEvents(int index) {
      return worldEvents_[index];
    }
    ...
    public override void WriteTo(pb::ICodedOutputStream output) {
      ...
      if (worldEvents_.Count > 0) {
        output.WriteMessageArray(1, field_names[0], worldEvents_);
      }
    }
    ...
    public override int SerializedSize {
      get {
        ...
        size = 0;
        foreach (global::com.nkm.framework.protocol.WorldEvent element in WorldEventsList) {
          size += pb::CodedOutputStream.ComputeMessageSize(1, element);
        }
        memoizedSerializedSize = size;
        return size;
    ...
    public override int GetHashCode() {
      int hash = GetType().GetHashCode();
      foreach(global::com.nkm.framework.protocol.WorldEvent i in worldEvents_)
        hash ^= i.GetHashCode();
      return hash;
    }
    ...
    public override bool Equals(object obj) {
      ...
      if (other == null) return false;
      if(worldEvents_.Count != other.worldEvents_.Count) return false;
      for(int ix=0; ix < worldEvents_.Count; ix++)
        if(!worldEvents_[ix].Equals(other.worldEvents_[ix])) return false;
      return true;
    }
    ...
    public sealed partial class Builder : pb::GeneratedBuilderLite<TSCGetWorldEvent, Builder> {
      ...
      public override TSCGetWorldEvent DefaultInstanceForType {
        get { return global::com.nkm.framework.protocol.TSCGetWorldEvent.DefaultInstance; }
      }
      ...
      public override Builder MergeFrom(TSCGetWorldEvent other) {
        if (other == global::com.nkm.framework.protocol.TSCGetWorldEvent.DefaultInstance) return this;
        PrepareBuilder();
        if (other.worldEvents_.Count != 0) {
          result.worldEvents_.Add(other.worldEvents_);
        }
        return this;
      }
      ...
      public override Builder MergeFrom(pb::ICodedInputStream input, pb::ExtensionRegistry extensionRegistry) {
        ...
        while (input.ReadTag(out tag, out field_name)) {
          ...
          switch (tag) {
            ...
            case 10: {
              input.ReadMessageArray(tag, field_name, result.worldEvents_, global::com.nkm.framework.protocol.WorldEvent.DefaultInstance, extensionRegistry);
              break;
            }
          }
        }
      ...
      public pbc::IPopsicleList<global::com.nkm.framework.protocol.WorldEvent> WorldEventsList {
        get { return PrepareBuilder().worldEvents_; }
      }
      public int WorldEventsCount {
        get { return result.WorldEventsCount; }
      }
      public global::com.nkm.framework.protocol.WorldEvent GetWorldEvents(int index) {
        return result.GetWorldEvents(index);
      }
      public Builder SetWorldEvents(int index, global::com.nkm.framework.protocol.WorldEvent value) {
        pb::ThrowHelper.ThrowIfNull(value, "value");
        PrepareBuilder();
        result.worldEvents_[index] = value;
        return this;
      }
      public Builder SetWorldEvents(int index, global::com.nkm.framework.protocol.WorldEvent.Builder builderForValue) {
        pb::ThrowHelper.ThrowIfNull(builderForValue, "builderForValue");
        PrepareBuilder();
        result.worldEvents_[index] = builderForValue.Build();
        return this;
      }
      public Builder AddWorldEvents(global::com.nkm.framework.protocol.WorldEvent value) {
        pb::ThrowHelper.ThrowIfNull(value, "value");
        PrepareBuilder();
        result.worldEvents_.Add(value);
        return this;
      }
      public Builder AddWorldEvents(global::com.nkm.framework.protocol.WorldEvent.Builder builderForValue) {
        pb::ThrowHelper.ThrowIfNull(builderForValue, "builderForValue");
        PrepareBuilder();
        result.worldEvents_.Add(builderForValue.Build());
        return this;
      }
      public Builder AddRangeWorldEvents(scg::IEnumerable<global::com.nkm.framework.protocol.WorldEvent> values) {
        PrepareBuilder();
        result.worldEvents_.Add(values);
        return this;
      }
      public Builder ClearWorldEvents() {
        PrepareBuilder();
        result.worldEvents_.Clear();
        return this;
      }
    }
  ...
  public sealed partial class WorldEvent : pb::GeneratedMessageLite<WorldEvent, WorldEvent.Builder> {
    private WorldEvent() { }
    private static readonly WorldEvent defaultInstance = new WorldEvent().MakeReadOnly();
    private static readonly string[] _worldEventFieldNames = new string[] { "configId", "time", "type" };
    private static readonly uint[] _worldEventFieldTags = new uint[] { 8, 24, 16 };
    #if UNITY_EDITOR
     [pb.FieldNumber] 
     #endif//
    public static WorldEvent DefaultInstance {
      get { return defaultInstance; }
    }
     ...
     [pb.FieldNumber] 
     #endif//
    public override WorldEvent DefaultInstanceForType {
      get { return DefaultInstance; }
    }
    
    protected override WorldEvent ThisMessage {
      get { return this; }
    }
    ...
    public override void WriteTo(pb::ICodedOutputStream output) {
      int size = SerializedSize;
      string[] field_names = _worldEventFieldNames;
      if (hasConfigId) {
        output.WriteInt32(1, field_names[0], ConfigId);
      }
      if (hasType) {
      ...
      if (hasTime) {
        output.WriteInt64(3, field_names[1], Time);
      }
    }
    ...
    public override bool Equals(object obj) {
      WorldEvent other = obj as WorldEvent;
      if (other == null) return false;
      if (hasConfigId != other.hasConfigId || (hasConfigId && !configId_.Equals(other.configId_))) return false;
     ...
     [pb.FieldNumber] 
     #endif//
    public static WorldEvent ParseFrom(pb::ByteString data) {
      return ((Builder) CreateBuilder().MergeFrom(data)).BuildParsed();
    }
    #if UNITY_EDITOR
     [pb.FieldNumber] 
     #endif//
    public static WorldEvent ParseFrom(pb::ByteString data, pb::ExtensionRegistry extensionRegistry) {
      return ((Builder) CreateBuilder().MergeFrom(data, extensionRegistry)).BuildParsed();
    }
    #if UNITY_EDITOR
     [pb.FieldNumber] 
     #endif//
    public static WorldEvent ParseFrom(byte[] data) {
      return ((Builder) CreateBuilder().MergeFrom(data)).BuildParsed();
    }
    #if UNITY_EDITOR
     [pb.FieldNumber] 
     #endif//
    public static WorldEvent ParseFrom(byte[] data, pb::ExtensionRegistry extensionRegistry) {
      return ((Builder) CreateBuilder().MergeFrom(data, extensionRegistry)).BuildParsed();
    }
    #if UNITY_EDITOR
     [pb.FieldNumber] 
     #endif//
    public static WorldEvent ParseFrom(global::System.IO.Stream input) {
      return ((Builder) CreateBuilder().MergeFrom(input)).BuildParsed();
    }
    #if UNITY_EDITOR
     [pb.FieldNumber] 
     #endif//
    public static WorldEvent ParseFrom(global::System.IO.Stream input, pb::ExtensionRegistry extensionRegistry) {
      return ((Builder) CreateBuilder().MergeFrom(input, extensionRegistry)).BuildParsed();
    }
    #if UNITY_EDITOR
     [pb.FieldNumber] 
     #endif//
    public static WorldEvent ParseDelimitedFrom(global::System.IO.Stream input) {
      return CreateBuilder().MergeDelimitedFrom(input).BuildParsed();
    }
    #if UNITY_EDITOR
     [pb.FieldNumber] 
     #endif//
    public static WorldEvent ParseDelimitedFrom(global::System.IO.Stream input, pb::ExtensionRegistry extensionRegistry) {
      return CreateBuilder().MergeDelimitedFrom(input, extensionRegistry).BuildParsed();
    }
    #if UNITY_EDITOR
     [pb.FieldNumber] 
     #endif//
    public static WorldEvent ParseFrom(pb::ICodedInputStream input) {
      return ((Builder) CreateBuilder().MergeFrom(input)).BuildParsed();
    }
    #if UNITY_EDITOR
     [pb.FieldNumber] 
     #endif//
    public static WorldEvent ParseFrom(pb::ICodedInputStream input, pb::ExtensionRegistry extensionRegistry) {
      return ((Builder) CreateBuilder().MergeFrom(input, extensionRegistry)).BuildParsed();
    }
    private WorldEvent MakeReadOnly() {
      return this;
    }
    ...
    public override Builder CreateBuilderForType() { return new Builder(); }
     ...
     [pb.FieldNumber] 
     #endif//
    public static Builder CreateBuilder(WorldEvent prototype) {
      return new Builder(prototype);
    }
    
    public sealed partial class Builder : pb::GeneratedBuilderLite<WorldEvent, Builder> {
      protected override Builder ThisBuilder {
        get { return this; }
      }
      public Builder() {
      ...
      internal Builder(WorldEvent cloneFrom) {
        result = cloneFrom;
        resultIsReadOnly = true;
      }
      
      private bool resultIsReadOnly;
      private WorldEvent result;
      
      private WorldEvent PrepareBuilder() {
        if (resultIsReadOnly) {
          WorldEvent original = result;
      ...
      protected override WorldEvent MessageBeingBuilt {
        get { return PrepareBuilder(); }
      }
      ...
      public override WorldEvent DefaultInstanceForType {
        get { return global::com.nkm.framework.protocol.WorldEvent.DefaultInstance; }
      }
      
      public override WorldEvent BuildPartial() {
        if (resultIsReadOnly) {
          return result;
        }
        resultIsReadOnly = true;
      ...
      public override Builder MergeFrom(pb::IMessageLite other) {
        if (other is WorldEvent) {
          return MergeFrom((WorldEvent) other);
        } else {
          base.MergeFrom(other);
          return this;
        }
      ...
      public override Builder MergeFrom(WorldEvent other) {
        if (other == global::com.nkm.framework.protocol.WorldEvent.DefaultInstance) return this;
        PrepareBuilder();
        if (other.HasConfigId) {
          ConfigId = other.ConfigId;
        }
      ...
      public override Builder MergeFrom(pb::ICodedInputStream input, pb::ExtensionRegistry extensionRegistry) {
        ...
        while (input.ReadTag(out tag, out field_name)) {
          if(tag == 0 && field_name != null) {
            int field_ordinal = global::System.Array.BinarySearch(_worldEventFieldNames, field_name, global::System.StringComparer.Ordinal);
            if(field_ordinal >= 0)
              tag = _worldEventFieldTags[field_ordinal];
            else {
              ParseUnknownField(input, extensionRegistry, tag, field_name);
              continue;
            }
  ...
  public sealed partial class TCSGetPurchase : pb::GeneratedMessageLite<TCSGetPurchase, TCSGetPurchase.Builder> {
    private TCSGetPurchase() { }
    private static readonly TCSGetPurchase defaultInstance = new TCSGetPurchase().MakeReadOnly();
    private static readonly string[] _tCSGetPurchaseFieldNames = new string[] {  };
    private static readonly uint[] _tCSGetPurchaseFieldTags = new uint[] {  };
    #if UNITY_EDITOR
     [pb.FieldNumber] 
     #endif//
    public static TCSGetPurchase DefaultInstance {
      get { return defaultInstance; }
    }
    ...
    protected override TCSGetPurchase ThisMessage {
      get { return this; }
    }
    ...
    public override void WriteTo(pb::ICodedOutputStream output) {
      int size = SerializedSize;
      string[] field_names = _tCSGetPurchaseFieldNames;
    }
    ...
    public override bool Equals(object obj) {
      TCSGetPurchase other = obj as TCSGetPurchase;
      if (other == null) return false;
      return true;
    }
     ...
     [pb.FieldNumber] 
     #endif//
    public static TCSGetPurchase ParseFrom(pb::ByteString data) {
      return ((Builder) CreateBuilder().MergeFrom(data)).BuildParsed();
    }
    #if UNITY_EDITOR
     [pb.FieldNumber] 
     #endif//
    public static TCSGetPurchase ParseFrom(pb::ByteString data, pb::ExtensionRegistry extensionRegistry) {
      return ((Builder) CreateBuilder().MergeFrom(data, extensionRegistry)).BuildParsed();
    }
    #if UNITY_EDITOR
     [pb.FieldNumber] 
     #endif//
    public static TCSGetPurchase ParseFrom(byte[] data) {
      return ((Builder) CreateBuilder().MergeFrom(data)).BuildParsed();
    }
    #if UNITY_EDITOR
     [pb.FieldNumber] 
     #endif//
    public static TCSGetPurchase ParseFrom(byte[] data, pb::ExtensionRegistry extensionRegistry) {
      return ((Builder) CreateBuilder().MergeFrom(data, extensionRegistry)).BuildParsed();
    }
    #if UNITY_EDITOR
     [pb.FieldNumber] 
     #endif//
    public static TCSGetPurchase ParseFrom(global::System.IO.Stream input) {
      return ((Builder) CreateBuilder().MergeFrom(input)).BuildParsed();
    }
    #if UNITY_EDITOR
     [pb.FieldNumber] 
     #endif//
    public static TCSGetPurchase ParseFrom(global::System.IO.Stream input, pb::ExtensionRegistry extensionRegistry) {
      return ((Builder) CreateBuilder().MergeFrom(input, extensionRegistry)).BuildParsed();
    }
    #if UNITY_EDITOR
     [pb.FieldNumber] 
     #endif//
    public static TCSGetPurchase ParseDelimitedFrom(global::System.IO.Stream input) {
      return CreateBuilder().MergeDelimitedFrom(input).BuildParsed();
    }
    #if UNITY_EDITOR
     [pb.FieldNumber] 
     #endif//
    public static TCSGetPurchase ParseDelimitedFrom(global::System.IO.Stream input, pb::ExtensionRegistry extensionRegistry) {
      return CreateBuilder().MergeDelimitedFrom(input, extensionRegistry).BuildParsed();
    }
    #if UNITY_EDITOR
     [pb.FieldNumber] 
     #endif//
    public static TCSGetPurchase ParseFrom(pb::ICodedInputStream input) {
      return ((Builder) CreateBuilder().MergeFrom(input)).BuildParsed();
    }
    #if UNITY_EDITOR
     [pb.FieldNumber] 
     #endif//
    public static TCSGetPurchase ParseFrom(pb::ICodedInputStream input, pb::ExtensionRegistry extensionRegistry) {
      return ((Builder) CreateBuilder().MergeFrom(input, extensionRegistry)).BuildParsed();
    }
    private TCSGetPurchase MakeReadOnly() {
      return this;
    }
    ...
    public override Builder CreateBuilderForType() { return new Builder(); }
     ...
     [pb.FieldNumber] 
     #endif//
    public static Builder CreateBuilder(TCSGetPurchase prototype) {
      return new Builder(prototype);
    }
    
    public sealed partial class Builder : pb::GeneratedBuilderLite<TCSGetPurchase, Builder> {
      protected override Builder ThisBuilder {
        get { return this; }
      }
      public Builder() {
      ...
      internal Builder(TCSGetPurchase cloneFrom) {
        result = cloneFrom;
        resultIsReadOnly = true;
      }
      
      private bool resultIsReadOnly;
      private TCSGetPurchase result;
      
      private TCSGetPurchase PrepareBuilder() {
        if (resultIsReadOnly) {
          TCSGetPurchase original = result;
          result = new TCSGetPurchase();
          resultIsReadOnly = false;
          MergeFrom(original);
        }
        return result;
      ...
      protected override TCSGetPurchase MessageBeingBuilt {
        get { return PrepareBuilder(); }
      }
      ...
      public override Builder MergeFrom(pb::IMessageLite other) {
        if (other is TCSGetPurchase) {
          return MergeFrom((TCSGetPurchase) other);
        } else {
          base.MergeFrom(other);
          return this;
        }
      ...
      public override Builder MergeFrom(pb::ICodedInputStream input, pb::ExtensionRegistry extensionRegistry) {
        ...
        while (input.ReadTag(out tag, out field_name)) {
          if(tag == 0 && field_name != null) {
            int field_ordinal = global::System.Array.BinarySearch(_tCSGetPurchaseFieldNames, field_name, global::System.StringComparer.Ordinal);
            if(field_ordinal >= 0)
              tag = _tCSGetPurchaseFieldTags[field_ordinal];
            else {
              ParseUnknownField(input, extensionRegistry, tag, field_name);
              continue;
            }
  ...
  public sealed partial class TSCGetPurchase : pb::GeneratedMessageLite<TSCGetPurchase, TSCGetPurchase.Builder> {
    private TSCGetPurchase() { }
    private static readonly TSCGetPurchase defaultInstance = new TSCGetPurchase().MakeReadOnly();
    private static readonly string[] _tSCGetPurchaseFieldNames = new string[] { "userResource" };
    private static readonly uint[] _tSCGetPurchaseFieldTags = new uint[] { 10 };
    #if UNITY_EDITOR
     [pb.FieldNumber] 
     #endif//
    public static TSCGetPurchase DefaultInstance {
      get { return defaultInstance; }
    }
    ...
    protected override TSCGetPurchase ThisMessage {
      get { return this; }
    }
    ...
    public override void WriteTo(pb::ICodedOutputStream output) {
      int size = SerializedSize;
      string[] field_names = _tSCGetPurchaseFieldNames;
      if (hasUserResource) {
        output.WriteMessage(1, field_names[0], UserResource);
      }
    }
    ...
    public override int SerializedSize {
      get {
        ...
        size = 0;
        if (hasUserResource) {
          size += pb::CodedOutputStream.ComputeMessageSize(1, UserResource);
        }
        memoizedSerializedSize = size;
        return size;
      }
    ...
    public override int GetHashCode() {
      int hash = GetType().GetHashCode();
      if (hasUserResource) hash ^= userResource_.GetHashCode();
      return hash;
    }
    
    public override bool Equals(object obj) {
      TSCGetPurchase other = obj as TSCGetPurchase;
      if (other == null) return false;
      if (hasUserResource != other.hasUserResource || (hasUserResource && !userResource_.Equals(other.userResource_))) return false;
      return true;
    }
     ...
     [pb.FieldNumber] 
     #endif//
    public static TSCGetPurchase ParseFrom(pb::ByteString data) {
      return ((Builder) CreateBuilder().MergeFrom(data)).BuildParsed();
    }
    #if UNITY_EDITOR
     [pb.FieldNumber] 
     #endif//
    public static TSCGetPurchase ParseFrom(pb::ByteString data, pb::ExtensionRegistry extensionRegistry) {
      return ((Builder) CreateBuilder().MergeFrom(data, extensionRegistry)).BuildParsed();
    }
    #if UNITY_EDITOR
     [pb.FieldNumber] 
     #endif//
    public static TSCGetPurchase ParseFrom(byte[] data) {
      return ((Builder) CreateBuilder().MergeFrom(data)).BuildParsed();
    }
    #if UNITY_EDITOR
     [pb.FieldNumber] 
     #endif//
    public static TSCGetPurchase ParseFrom(byte[] data, pb::ExtensionRegistry extensionRegistry) {
      return ((Builder) CreateBuilder().MergeFrom(data, extensionRegistry)).BuildParsed();
    }
    #if UNITY_EDITOR
     [pb.FieldNumber] 
     #endif//
    public static TSCGetPurchase ParseFrom(global::System.IO.Stream input) {
      return ((Builder) CreateBuilder().MergeFrom(input)).BuildParsed();
    }
    #if UNITY_EDITOR
     [pb.FieldNumber] 
     #endif//
    public static TSCGetPurchase ParseFrom(global::System.IO.Stream input, pb::ExtensionRegistry extensionRegistry) {
      return ((Builder) CreateBuilder().MergeFrom(input, extensionRegistry)).BuildParsed();
    }
    #if UNITY_EDITOR
     [pb.FieldNumber] 
     #endif//
    public static TSCGetPurchase ParseDelimitedFrom(global::System.IO.Stream input) {
      return CreateBuilder().MergeDelimitedFrom(input).BuildParsed();
    }
    #if UNITY_EDITOR
     [pb.FieldNumber] 
     #endif//
    public static TSCGetPurchase ParseDelimitedFrom(global::System.IO.Stream input, pb::ExtensionRegistry extensionRegistry) {
      return CreateBuilder().MergeDelimitedFrom(input, extensionRegistry).BuildParsed();
    }
    #if UNITY_EDITOR
     [pb.FieldNumber] 
     #endif//
    public static TSCGetPurchase ParseFrom(pb::ICodedInputStream input) {
      return ((Builder) CreateBuilder().MergeFrom(input)).BuildParsed();
    }
    #if UNITY_EDITOR
     [pb.FieldNumber] 
     #endif//
    public static TSCGetPurchase ParseFrom(pb::ICodedInputStream input, pb::ExtensionRegistry extensionRegistry) {
      return ((Builder) CreateBuilder().MergeFrom(input, extensionRegistry)).BuildParsed();
    }
    private TSCGetPurchase MakeReadOnly() {
      return this;
    }
    ...
    public override Builder CreateBuilderForType() { return new Builder(); }
     ...
     [pb.FieldNumber] 
     #endif//
    public static Builder CreateBuilder(TSCGetPurchase prototype) {
      return new Builder(prototype);
    }
    
    public sealed partial class Builder : pb::GeneratedBuilderLite<TSCGetPurchase, Builder> {
      protected override Builder ThisBuilder {
        get { return this; }
      }
      public Builder() {
      ...
      internal Builder(TSCGetPurchase cloneFrom) {
        result = cloneFrom;
        resultIsReadOnly = true;
      }
      
      private bool resultIsReadOnly;
      private TSCGetPurchase result;
      
      private TSCGetPurchase PrepareBuilder() {
        if (resultIsReadOnly) {
          TSCGetPurchase original = result;
          result = new TSCGetPurchase();
          resultIsReadOnly = false;
          MergeFrom(original);
        }
        return result;
      ...
      protected override TSCGetPurchase MessageBeingBuilt {
        get { return PrepareBuilder(); }
      }
      ...
      public override Builder MergeFrom(pb::IMessageLite other) {
        if (other is TSCGetPurchase) {
          return MergeFrom((TSCGetPurchase) other);
        } else {
          base.MergeFrom(other);
          return this;
        }
      ...
      public override Builder MergeFrom(pb::ICodedInputStream input, pb::ExtensionRegistry extensionRegistry) {
        ...
        while (input.ReadTag(out tag, out field_name)) {
          if(tag == 0 && field_name != null) {
            int field_ordinal = global::System.Array.BinarySearch(_tSCGetPurchaseFieldNames, field_name, global::System.StringComparer.Ordinal);
            if(field_ordinal >= 0)
              tag = _tSCGetPurchaseFieldTags[field_ordinal];
            else {
              ParseUnknownField(input, extensionRegistry, tag, field_name);
              continue;
            }
          ...
          switch (tag) {
            ...
            case 10: {
              ...
              UserResource = subBuilder.BuildPartial();
              break;
            }
          }
        }
      ...
      public Builder ClearUserResource() {
        PrepareBuilder();
        result.hasUserResource = false;
        result.userResource_ = null;
        return this;
      }
    }
