...
_BUILDING = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='pro_id', full_name='com.game.framework.resource.data.BUILDING.pro_id', index=15,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='bldg_func_table_name', full_name='com.game.framework.resource.data.BUILDING.bldg_func_table_name', index=16,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='bldg_func_table_id', full_name='com.game.framework.resource.data.BUILDING.bldg_func_table_id', index=17,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='bldg_strength_lim', full_name='com.game.framework.resource.data.BUILDING.bldg_strength_lim', index=18,
